...
module.exports = function(req, res, next, use) {
  ...
  if(typeof query == 'object') parser.convertStringsToObjectIds(query);
  if(typeof req.data == 'object') parser.convertStringsToObjectIds(req.data);
        ...
        if(req.method === 'GET') {
          ...
          function each(err, doc) {
            ...
            if(doc && typeof doc == 'object') {
              parser.convertObjectIdsToStrings(doc);
            }
