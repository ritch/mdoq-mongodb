...
//                
//                fs.writeFileSync(__dirname + '/support/mongodb-test.jpg.txt', fileData.toString('base64'), 'utf8');
//                fs.writeFileSync(__dirname + '/support/test.jpg.txt', fs.readFileSync(__dirname + '/support/test.jpg').toString('base64'), 'utf8');
//                
